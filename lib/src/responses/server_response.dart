...
class ServerResponse {
  ...
  ServerResponse.from(ApiResponse response) : this(
    ...
    // which type is Map
      couchDbMessage:
      response.json['couchdb'] is String ? response.json['couchdb'] as String : null,
      ...
      ddocCache: (response.json['ddoc_cache'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)),
      couchDb: response.json['couchdb'] is Map ? (response.json['couchdb'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)) : null,
      pread: (response.json['pread'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)),
      couchReplicator: (response.json['couch_replicator'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)),
      mem3: (response.json['mem3'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Map<String, Object>>>(k, (v as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)))),
      couchLog: (response.json['couch_log'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Map<String, Object>>>(k, (v as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)))),
      rexi: (response.json['rexi'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)),
      globalChanges: (response.json['global_changes'] as Map<String, Object>)?.map((k, v) => MapEntry<String, Map<String, Object>>(k, v as Map<String, Object>)),
      uptime: response.json['uptime'] as int,
      memory: (response.json['memory'] as Map<String, Object>)?.map((k, v) => MapEntry<String, int>(k, v as int)),
      ...
      uuids: (response.json['uuids'] as List<Object>)?.map((e) => e as String)?.toList(),
      list: response.json['list'] as List<Object>,
      name: response.json['name'] as String,
      roles: (response.json['roles'] as List<Object>)?.map((v) => v as String)?.toList(),
